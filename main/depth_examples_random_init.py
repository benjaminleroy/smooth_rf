    ...
    for i, max_depth in depth_iter:
        for j in np.arange(n_draws):
            ...
            smooth_ew_r_c, smooth_ew_r_c_last ,_, c1 = smooth_base.smooth(
                                ...
                                verbose = False,
                                all_trees = True,
                                initial_lamb_seed = get_random_seed())
...
if create_figs:
    ...
    if select == 1:
        ...
        data_vis.to_csv("images/tree1_reg_all_microsoft_rand_init.csv")

        save_as_pdf_pages([reg_vis1 + labs(title = "1 tree, reg") +\
                           theme(figure_size = (8,6))],
                          filename = "images/tree1_reg_all_microsoft_rand_init.pdf")
    ...
    if select == 10:
        ...
        data_vis10.to_csv("images/tree10_reg_all_microsoft_rand_init.csv")

        save_as_pdf_pages([reg_vis10 + labs(title = "10 tree, reg") +\
                           theme(figure_size = (8,6))],
                         filename = "images/tree10_reg_all_microsoft_rand_init.pdf")
    ...
    if select == 300:
        ...
        data_vis300.to_csv("images/tree300_reg_all_microsoft_rand_init.csv")

        save_as_pdf_pages([reg_vis300 + labs(title = "300 tree, reg") +\
                           theme(figure_size = (8,6))],
                         filename = "images/tree300_reg_all_microsoft_rand_init.pdf")
