...
def smooth_wrapper(random_forest,
                   X_train, y_train,
                   params):
    d_style, inner_distance, parent_all, no_constraint, initial_lamb, class_loss, \
    adam_values = params
...
num_jobs = len(list(itertools.product(d_style_opt,inner_distance_opts,
                                     parent_all_opts,
                                     no_constraint_opts,
                                     initial_lamb_opts,
                                     class_loss_opts,
...
s_all_output = Parallel(n_jobs=-1, verbose=10)(delayed(smooth_wrapper)(random_forest,
                                       X_train,
                                       y_train,
                                       params) for params in list(itertools.product(d_style_opt,
                                     inner_distance_opts,
                                     parent_all_opts,
                                     no_constraint_opts,
                                     initial_lamb_opts,
