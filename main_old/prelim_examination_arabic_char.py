...
data_all = pd.read_csv("data/arabic_letters/csvTrainImages 60k x 784.csv",
                   header = -1)

y_all = pd.read_csv("data/arabic_letters/csvTrainLabel 60k x 1.csv",
                    header = -1)
...
# dropping columns with just 0
keep = data_all.max(axis = 0) != 0
data_all = data_all[keep.index[keep]]
