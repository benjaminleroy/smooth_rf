...
data_train = pd.read_csv(path + "data/tania_data/" + "3609_1_data.csv")
y_all = data_train["class"]
y_all = y_all.ravel()
data_all = data_train.drop(columns = ["class"])
...
reg_or_class = "class"
data_name = "tania_" + reg_or_class
n_sim = 20
depth_range = np.arange(5,60,5)
np.random.seed(100)
verbose = True
